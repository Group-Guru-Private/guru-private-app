...
describe('Cancel order DELETE /orders/:id', () => {
  describe('Success deleted', () => {
    test('should response with data result', done => {
      request(app)
        ...
        .end((err, res) => {
          ...
          expect(body).toHaveProperty('message', "Successfully deleted this order !!!")
          done()
        })
    })
  })

  describe('Error cancel because no access token', () => {
  ...
  describe('Error cancel because wrong access token', () => {
